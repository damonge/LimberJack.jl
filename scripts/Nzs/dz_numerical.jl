...
@everywhere @model function model(data;
    ...
    DESwl__0_e_dz ~ TruncatedNormal(0.0, 0.017, -0.2, 0.2)
    DESwl__1_e_dz ~ TruncatedNormal(0.0, 0.017, -0.2, 0.2)
    DESwl__2_e_dz ~ TruncatedNormal(0.0, 0.013, -0.2, 0.2)
    DESwl__3_e_dz ~ TruncatedNormal(0.0, 0.015, -0.2, 0.2)
