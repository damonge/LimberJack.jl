...
nz_path = "data"
datas = [Data("DESgc", "DESgc", 1, 1, cl_path=cl_path, cov_path=cov_path, nz_path=nz_path),
         ...
         #Data("DESgc", "DESgc", 1, 4, cl_path=cl_path, cov_path=cov_path, nz_path=nz_path),
...
@model function model(data_vector)
    ...
    cosmology = LimberJack.Cosmology(Ωm, 0.05, h, 0.96, s8,
                                     tk_mode="EisHu",
                                     Pk_mode="Halofit")
    theory = Theory(cosmology, Cls_metas, Nzs)
