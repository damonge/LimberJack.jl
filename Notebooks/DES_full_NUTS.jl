...
@model function model(data_vector; cov_tot=cov_tot)
    ...
    m0 ~ Normal(0.012, 0.023) #Normal(0.0, 0.035)
    m1 ~ Normal(0.012, 0.023) #Normal(0.0, 0.035)
    m2 ~ Normal(0.012, 0.023) #Normal(0.0, 0.035)
    m3 ~ Normal(0.012, 0.023) #Normal(0.0, 0.035)
