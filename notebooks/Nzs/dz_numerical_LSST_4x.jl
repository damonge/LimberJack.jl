...
@everywhere @model function model(data;
    ...
    DESwl__0_e_dz ~ TruncatedNormal(0.0, 4*0.017, -0.8, 0.8)
    DESwl__1_e_dz ~ TruncatedNormal(0.0, 4*0.017, -0.8, 0.8)
    DESwl__2_e_dz ~ TruncatedNormal(0.0, 4*0.013, -0.8, 0.8)
    DESwl__3_e_dz ~ TruncatedNormal(0.0, 4*0.015, -0.8, 0.8)
...
folname = string("dz_LSST_numerical_4x_", "TAP_", TAP)
