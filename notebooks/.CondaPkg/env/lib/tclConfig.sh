...
# installed.
TCL_PREFIX='/home/jaimerz/Glamdring/LimberJack.jl/notebooks/.CondaPkg/env'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/jaimerz/Glamdring/LimberJack.jl/notebooks/.CondaPkg/env'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/home/jaimerz/Glamdring/LimberJack.jl/notebooks/.CondaPkg/env/lib -Wl,-rpath-link,/home/jaimerz/Glamdring/LimberJack.jl/notebooks/.CondaPkg/env/lib -L/home/jaimerz/Glamdring/LimberJack.jl/notebooks/.CondaPkg/env/lib -Wl,--export-dynamic '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/jaimerz/Glamdring/LimberJack.jl/notebooks/.CondaPkg/env/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/jaimerz/Glamdring/LimberJack.jl/notebooks/.CondaPkg/env/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/jaimerz/Glamdring/LimberJack.jl/notebooks/.CondaPkg/env/include'
...
# compiled.
TCL_SRC_DIR='/home/jaimerz/Glamdring/LimberJack.jl/notebooks/.CondaPkg/env/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/home/jaimerz/Glamdring/LimberJack.jl/notebooks/.CondaPkg/env/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/jaimerz/Glamdring/LimberJack.jl/notebooks/.CondaPkg/env/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/jaimerz/Glamdring/LimberJack.jl/notebooks/.CondaPkg/env/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/jaimerz/Glamdring/LimberJack.jl/notebooks/.CondaPkg/env/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/jaimerz/Glamdring/LimberJack.jl/notebooks/.CondaPkg/env/lib/libtclstub8.6.a'
